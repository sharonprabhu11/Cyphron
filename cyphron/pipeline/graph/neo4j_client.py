...
class Neo4jGraphClient:
    ...
    def ping(self) -> dict[str, Any]:
        records, _, _ = self.driver.execute_query(queries.PING_QUERY)
    ...
    def run_shared_device_query(self, *, limit: int = 25) -> list[dict[str, Any]]:
        records, _, _ = self.driver.execute_query(
...
def initialize_neo4j():
    ...
    _graph_client = Neo4jGraphClient(driver)
